...
export const GOAL_HASH_PATH = ".yoloop/goal.sha256";
export const POLICY_PATH = "LOOP_POLICY.json";
export const TASKS_PATH = "TASKS.json";
export const ADAPTERS_PATH = "ADAPTERS.json";
export const EVENTS_PATH = ".yoloop/events.jsonl";

export const PLAN_PATH = "PLAN.html";
export const WORKER_PROMPT_PATH = "WORKER_PROMPT.html";
export const CRITIC_PROMPT_PATH = "CRITIC_PROMPT.html";
export const PROGRESS_PATH = "PROGRESS.html";
export const FAILURES_PATH = "FAILURES.html";
export const DECISIONS_PATH = "DECISIONS.html";
